...
type TaskDetails struct {
	...
	Now    *google.Timestamp `protobuf:"bytes,2,opt,name=now,proto3" json:"now,omitempty"`
...
func (m *TaskDetails) GetNow() *google.Timestamp {
	if m != nil {
		return m.Now
	}
	return nil
...
type Stats struct {
	...
	LastWake *google.Timestamp `protobuf:"bytes,6,opt,name=last_wake,json=lastWake,proto3" json:"last_wake,omitempty"`
...
func (m *Stats) GetLastWake() *google.Timestamp {
	if m != nil {
		return m.LastWake
	}
	return nil
...
func init() {
	proto.RegisterEnum("rs.tokio.console.tasks.Task_Kind", Task_Kind_name, Task_Kind_value)
	proto.RegisterType((*TaskUpdate)(nil), "rs.tokio.console.tasks.TaskUpdate")
	proto.RegisterMapType((map[uint64]*Stats)(nil), "rs.tokio.console.tasks.TaskUpdate.StatsUpdateEntry")
	proto.RegisterType((*TaskDetails)(nil), "rs.tokio.console.tasks.TaskDetails")
	proto.RegisterType((*Task)(nil), "rs.tokio.console.tasks.Task")
	proto.RegisterType((*Stats)(nil), "rs.tokio.console.tasks.Stats")
}
...
var fileDescriptor_0699f8eed34b53e1 = []byte{
	...
	,
}
...
func (this *TaskDetails) String() string {
	...
	s := strings.Join([]string{`&TaskDetails{`,
		...
		`Now:` + strings.Replace(fmt.Sprintf("%v", this.Now), "Timestamp", "google.Timestamp", 1) + `,`,
...
func (this *Stats) String() string {
	...
	s := strings.Join([]string{`&Stats{`,
		...
		`LastWake:` + strings.Replace(fmt.Sprintf("%v", this.LastWake), "Timestamp", "google.Timestamp", 1) + `,`,
