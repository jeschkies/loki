...
type Update struct {
	...
	Now *google.Timestamp `protobuf:"bytes,1,opt,name=now,proto3" json:"now,omitempty"`
	// Task state update.
...
func (m *Update) GetNow() *google.Timestamp {
	if m != nil {
		return m.Now
	}
	return nil
...
func init() {
	proto.RegisterType((*InstrumentRequest)(nil), "rs.tokio.console.instrument.InstrumentRequest")
	proto.RegisterType((*TaskDetailsRequest)(nil), "rs.tokio.console.instrument.TaskDetailsRequest")
	proto.RegisterType((*PauseRequest)(nil), "rs.tokio.console.instrument.PauseRequest")
	proto.RegisterType((*ResumeRequest)(nil), "rs.tokio.console.instrument.ResumeRequest")
	proto.RegisterType((*Update)(nil), "rs.tokio.console.instrument.Update")
	proto.RegisterType((*PauseResponse)(nil), "rs.tokio.console.instrument.PauseResponse")
	proto.RegisterType((*ResumeResponse)(nil), "rs.tokio.console.instrument.ResumeResponse")
}
...
var fileDescriptor_7b6d8fc1efdebcfa = []byte{
	...
	,
}
...
func (this *InstrumentRequest) GoString() string {
	...
	s := make([]string, 0, 4)
	s = append(s, "&instrument.InstrumentRequest{")
	s = append(s, "}")
...
func (this *TaskDetailsRequest) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&instrument.TaskDetailsRequest{")
	if this.Id != nil {
...
func (this *PauseRequest) GoString() string {
	...
	s := make([]string, 0, 4)
	s = append(s, "&instrument.PauseRequest{")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *ResumeRequest) GoString() string {
	...
	s := make([]string, 0, 4)
	s = append(s, "&instrument.ResumeRequest{")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *PauseResponse) GoString() string {
	...
	s := make([]string, 0, 4)
	s = append(s, "&instrument.PauseResponse{")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *ResumeResponse) GoString() string {
	...
	s := make([]string, 0, 4)
	s = append(s, "&instrument.ResumeResponse{")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (c *instrumentClient) WatchUpdates(ctx context.Context, in *InstrumentRequest, opts ...grpc.CallOption) (Instrument_WatchUpdatesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Instrument_serviceDesc.Streams[0], "/rs.tokio.console.instrument.Instrument/WatchUpdates", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *instrumentClient) WatchTaskDetails(ctx context.Context, in *TaskDetailsRequest, opts ...grpc.CallOption) (Instrument_WatchTaskDetailsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Instrument_serviceDesc.Streams[1], "/rs.tokio.console.instrument.Instrument/WatchTaskDetails", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *instrumentClient) Pause(ctx context.Context, in *PauseRequest, opts ...grpc.CallOption) (*PauseResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/rs.tokio.console.instrument.Instrument/Pause", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *instrumentClient) Resume(ctx context.Context, in *ResumeRequest, opts ...grpc.CallOption) (*ResumeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/rs.tokio.console.instrument.Instrument/Resume", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Instrument_Pause_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rs.tokio.console.instrument.Instrument/Pause",
	}
...
func _Instrument_Resume_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rs.tokio.console.instrument.Instrument/Resume",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
